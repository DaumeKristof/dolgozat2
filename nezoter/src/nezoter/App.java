...
public class App {
	...
	private void run() {
		...
		int sor = console.readInt("2.feladat: Kérem az ülõhely adatait. Sor: ");
		int szek = console.readInt("Székszám: ");
		if (test.getChairInfo(sor, szek).equals("x")) {
			System.out.println("A ülõhely foglalt.\n");
		} else {
			System.out.println("Az ülõhely szabad.\n");
		}
		System.out.println("3.feladat: Az elõadásra eddig " + test.soldTicket() + " jegyet adtak el, ez a nézõtér "+ Math.round(((double)test.soldTicket()/(20*15))*100) + "%-a.\n");
		...
		System.out.println("6. feladat: Összesen " + test.singleChair() + " darab 'egyedülálló' üres hely van a nézõtéren.\n");
		System.out.println("7. feladat: A szabad.txt elõállítása.");
